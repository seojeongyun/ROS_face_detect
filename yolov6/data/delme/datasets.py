...
from yolov6.data.delme.data_augment import (
    augment_hsv,
    letterbox,
    mixup,
    random_affine,
...
def img2label_paths(img_paths):
    ...
    # ex) x = '/storage/hrlee/coco/images/train2014/COCO_train2014_000000217726.jpg'
    # x.rsplit('/images/', 1) is ['/storage/hrlee/coco', 'train2014/COCO_train2014_000000217726.jpg']
...
class TrainValDataset(Dataset):
    ...
    def get_imgs_labels(self, img_dirs):
        ...
        assert img_paths, f"No images found in {img_dir}."  # if img_paths is None, assert operation incurs an error message!
