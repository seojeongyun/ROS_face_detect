...
class Detect(nn.Module):
    ...
    def __init__(self, num_classes=80, num_layers=3, inplace=True, head_layers=None, use_dfl=True,
        ...
        for i in range(num_layers):
            ...
            self.reg_preds_dist.append(head_layers[idx + 5])
    ...
    def forward(self, x):
        if self.training:
            ...
            reg_lrtb_list = torch.cat(reg_lrtb_list, dim=1)
            ...
            reg_lrtb_list = torch.cat(reg_lrtb_list, dim=-1).permute(0, 2, 1)
...
def EffiDeHead(channels_list, num_anchors, num_classes, reg_max=16, num_layers=3):
    ...
    if num_layers == 4:
        ...
        head_layers.add_module('reg_pred3_1',
                               # reg_pred3_1
                               nn.Conv2d(
                                   in_channels=channels_list[chx[3]],
                                   out_channels=4 * num_anchors,
