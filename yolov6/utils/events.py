...
def write_tbloss(tblogger, losses, step):
    # iou_loss  dfl_loss  cls_loss  rgt_loss rbox_loss   lk_loss
    tblogger.add_scalar("training/loss/cls", losses[2], step + 1)
    tblogger.add_scalar("training/loss/rbox", losses[4], step + 1)
    tblogger.add_scalar("training/loss/dfl", losses[1], step + 1)
    tblogger.add_scalar("training/loss/iou", losses[0], step + 1)
    tblogger.add_scalar("training/loss/rgt", losses[3], step + 1)
    tblogger.add_scalar("training/loss/lk", losses[5], step + 1)
    if len(losses) == 7:
        tblogger.add_scalar("training/loss/cwd", losses[6], step + 1)
