...
model = dict(
    type='YOLOv6s',
    pretrained='./weights/opt/yolov6s_opt.pt',
    scales='./weights/hs/yolov6s_scale.pt',
    depth_multiple=0.33,
    width_multiple=0.50,
    backbone=dict(
        type='EfficientRep',
...
ptq = dict(
    ...
    calib_output_path='./weights/train_v6s_ptq',
...
qat = dict(
    calib_pt='./weights/train_v6s_ptq/6s_opt/yolov6s_opt_calib_histogram.pt',
    sensitive_layers_skip=False,
    sensitive_layers_list=['detect.stems.0.conv',
                           'detect.stems.1.conv',
                           'detect.stems.2.conv',
...
# Choose Rep-block by the training Mode, choices=["repvgg", "hyper-search", "repopt_"]
training_mode = 'repopt_'
